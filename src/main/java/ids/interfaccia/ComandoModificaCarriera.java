...
public class ComandoModificaCarriera implements Comando {
	public static final String codiceComando="11";
	public static final String descrizioneComando="Modifica carriera";
	...
	public void esegui() {
		...
		Map<String, List<String>> result = DipendenteHandler.getInstance().modificaCarriera(identificativoSupervisore);
		if (result == null) {
			...
			new ComandoScegliCarriera().esegui();
		}
	}
}
